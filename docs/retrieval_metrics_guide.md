...
This document defines the ranking metrics used in recommender notebooks (`recs_004`, `recs_006`, and retrieval work including `notebooks/retrieval_ranking/recs_008_history_blend_gridsearch.ipynb`) and how we aggregate them.
